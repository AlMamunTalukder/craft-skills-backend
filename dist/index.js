...
const attachRoutes = (sessionMiddleware) => {
    ...
    app.use((req, res, next) => {
        ...
        sessionMiddleware(req, res, (err) => {
            ...
            passport_1.default.session()(req, res, next);
        });
    });
...
async function bootstrap() {
    const normalizedUrl = await (0, db_1.default)();
    await (0, redis_1.connectRedis)();
    const sessionMiddleware = (0, express_session_1.default)({
        secret: index_2.default.sessionSecret,
        resave: false,
        saveUninitialized: false,
        store: connect_mongo_1.default.create({ mongoUrl: normalizedUrl, ttl: 24 * 60 * 60 }),
...
const shutdown = async (signal) => {
    ...
    try {
        ...
        logger_1.default.error(error, 'Error closing Redis connection');
    }
    try {
        await mongoose_1.default.disconnect();
    }
    catch (error) {
        logger_1.default.error(error, 'Error closing MongoDB connection');
    }
