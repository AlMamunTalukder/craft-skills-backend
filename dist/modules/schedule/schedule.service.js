...
const createSchedule = async (payload) => {
    ...
    return await schedule_model_1.Schedule.create(payload);
};
// Or use upsert (create or update)
const upsertSchedule = async (payload) => {
    let scheduleDoc = await schedule_model_1.Schedule.findOne();
    if (!scheduleDoc) {
        scheduleDoc = await schedule_model_1.Schedule.create(payload);
    }
    else {
...
const updateCompleteSchedule = async (payload) => {
