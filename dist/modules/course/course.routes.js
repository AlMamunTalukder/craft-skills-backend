...
router.post('/', (0, validateRequest_1.default)(course_dto_1.createCourseDto), course_controller_1.courseController.createCourse);
router.put('/:id', (0, validateRequest_1.default)(course_dto_1.updateCourseDto), course_controller_1.courseController.updateCourse);
