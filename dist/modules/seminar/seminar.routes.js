...
router.get('/:id', (0, auth_1.auth)(['admin']), seminar_controller_1.seminarController.getSeminarById);
// Admin routes (with auth)
router.post('/', (0, auth_1.auth)(['admin']), (0, validateRequest_1.default)(seminar_dto_1.createSeminarDto), seminar_controller_1.seminarController.createSeminar);
router.put('/:id', (0, auth_1.auth)(['admin']), (0, validateRequest_1.default)(seminar_dto_1.updateSeminarDto), seminar_controller_1.seminarController.updateSeminar);
router.put('/:id/status', (0, auth_1.auth)(['admin']), seminar_controller_1.seminarController.changeStatus);
router.delete('/:id', (0, auth_1.auth)(['admin']), seminar_controller_1.seminarController.deleteSeminar);
