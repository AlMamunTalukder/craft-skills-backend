...
router.put('/:id/status', (0, auth_1.auth)(['admin']), coursebatch_controller_1.courseBatchController.changeStatus);
router.delete('/:id', (0, auth_1.auth)(['admin']), coursebatch_controller_1.courseBatchController.deleteBatch);
