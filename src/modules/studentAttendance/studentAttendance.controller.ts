...
export const studentAttendanceController = {
    ...
    updateSpecialClass: async (req: Request, res: Response) => {
        try {
            ...
            console.log('Special class request:', { userId: user._id, className, attended });
            ...
            const existingAttendance = await Attendance.findOne({
                studentId: user._id,
                className,
                sessionType: 'special', // Use sessionType instead of attendanceType
                date: today,
            });
            ...
            if (existingAttendance) {
                ...
                existingAttendance.markedAt = new Date();
                await existingAttendance.save();
                console.log('Updated existing special class attendance');
            } else {
                ...
                const newAttendance = new Attendance({
                    ...
                    batchId: typedUserData.batchNumber,
                    className,
                    sessionType: 'special', // Use 'special' as sessionType
                    attended,
                    date: today,
                    markedAt: new Date(),
                });
                await newAttendance.save();
                console.log('Created new special class attendance:', newAttendance);
            }
    ...
    updateGuestClass: async (req: Request, res: Response) => {
        try {
            ...
            console.log('Guest class request:', { userId: user._id, className, attended });
            ...
            const existingAttendance = await Attendance.findOne({
                studentId: user._id,
                className,
                sessionType: 'guest', // Use sessionType instead of attendanceType
                date: today,
            });

            console.log('Existing guest attendance:', existingAttendance);
            ...
            if (existingAttendance) {
                ...
                existingAttendance.markedAt = new Date();
                await existingAttendance.save();
                console.log('Updated existing guest class attendance');
            } else {
                // Create new attendance record
                const newAttendance = new Attendance({
                    studentId: user._id,
                    batchId: typedUserData.batchNumber,
                    className,
                    sessionType: 'guest', // Use 'guest' as sessionType
                    attended,
                    date: today,
                    markedAt: new Date(),
                });
                await newAttendance.save();
                console.log('Created new guest class attendance:', newAttendance);
            }
